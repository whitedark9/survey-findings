...
# TABLE (7.31) TRAINING FOR EARTHQUAKE

<div className={"flex flex-col lg:flex-row items-start py-6 gap-4 lg:gap-0"}>

<SimpleBarChart data={data["household_preparedness_response"]["training_for_earthquake"]} />

<PieChartWithLabel
  data={data["household_preparedness_response"]["training_for_earthquake"]}
/>

</div>

<Callout type={"info"}>FINDINGS: {findings["training_for_earthquake"]}</Callout>
